...
$(document).ready(function(){
	$(".s6_7").click(function(){
		...
		$(".s6_7")[0].style.background = "#fafafa";
		...
		$(".s6_7_1")[0].style.background = "#fafafa";
		$(".s6_7_2")[0].style.background = "#999999";
		$(".s6_7_3")[0].style.background = "#999999";
		$(".s6_7_4")[0].style.background = "#999999";
		
		$("#page6_7_1")[0].style.display = "block";
		$("#page6_7_2")[0].style.display = "none";
