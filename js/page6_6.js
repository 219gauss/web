...
$(document).ready(function(){
	$(".s6_6").click(function(){
		...
		$(".s6_6")[0].style.background = "#fafafa";
...
$(document).ready(function(){
	$("#page6_6_pcap_type").change(function(){
		console.log($(this).val());
		if ($(this).val() == "enhanced") {
			$(".page6_6_pcap_feature_export").hide();
		} else {
			$(".page6_6_pcap_feature_export").show();
		}
	});
});